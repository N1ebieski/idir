$(document).on(
    'change.n1ebieski/idir/web/scripts/view/dir@toggleCodeSms',
...
$(document).on(
    'change.n1ebieski/idir/web/scripts/view/dir@toggleCodeTransfer',
...
$(document).on(
    'change.n1ebieski/idir/web/scripts/view/dir@toggleBacklink',
    'select#backlink',
    function () {
        let $select = JSON.parse($(this).find('option:selected').attr('data'));
