...
$(document).on('ready.n1ebieski/idir/admin/scripts/plugins/jquery-googlemap@init', function () {
    let $map = $('#map');
...
$(document).on('readyAndAjax.n1ebieski/idir/admin/scripts/plugins/jquery-googlemap@initSelect', function () {
    let $map = $("#map-select");
...
$(document).on(
    'click.n1ebieski/idir/admin/scripts/plugins/jquery-googlemap@remove',
    '#remove-marker',
    function (e) {
        e.preventDefault();
...
$(document).on(
    'click.n1ebieski/idir/admin/scripts/plugins/jquery-googlemap@add',
    '#add-marker',
