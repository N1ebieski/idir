    ...
    <div id="payment">
        <nav>
            <div class="btn-group btn-group-toggle nav d-block" data-toggle="buttons" id="nav-tab" role="tablist">
                ...
                <a class="nav-item btn btn-info {{ old('payment_type', $paymentType) === $type ? 'active' : null }}"
                id="nav-{{ $type }}-tab" data-toggle="tab" href="#nav-{{ $type }}" role="tab"
                aria-controls="nav-{{ $type }}" aria-selected="true">
                    <input type="radio" name="payment_type" value="{{ $type }}" id="nav-{{ $type }}-tab"
                    autocomplete="off" {{ old('payment_type', $paymentType) === $type ? 'checked' : null }}>
        ...
        <div class="tab-content mt-3" id="nav-tabContent">
            ...
            <div class="tab-pane fade {{ old('payment_type', $paymentType) === "transfer" ? 'show active' : null }}"
            ...
            <div class="tab-pane fade {{ old('payment_type', $paymentType) === "code_transfer" ? 'show active' : null }}"
            id="nav-code_transfer" role="tabpanel" aria-labelledby="nav-code_transfer-tab">
                ...
                <p>
                    {!! trans('idir::dirs.payment.code_transfer.info', [
                        'code_transfer_url' => config("services.{$driverByType('code_transfer')}.code_transfer.url")
                        . $paymentCodeTransferSelection->code,
            ...
            <div class="tab-pane fade {{ old('payment_type', $paymentType) === "code_sms" ? 'show active' : null }}"
