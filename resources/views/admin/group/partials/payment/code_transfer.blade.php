<div class="form-group">
    <label for="prices_code_transfer">{{ trans("idir::groups.payment.code_transfer") }}:</label>
                ...
                <div class="input-group-prepend">
                    <div class="input-group-text">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="price_code_transfer{{ $loop->index }}"
                            name="prices[code_transfer][{{ $loop->index }}][select]" {{ ($price->price !== null) ? 'checked' : null }}>
                            <input type="hidden" name="prices[code_transfer][{{ $loop->index }}][id]"
                            value="{{ $price->id ?? null }}">
                            <input type="hidden" name="prices[code_transfer][{{ $loop->index }}][type]"
                            value="code_transfer">
                            <label class="custom-control-label" for="price_code_transfer{{ $loop->index }}"></label>
                        </div>
                    </div>
                </div>
