<div class="form-group">
    <label for="prices_code_sms">{{ trans("idir::groups.payment.code_sms") }}:</label>
                ...
                <div class="input-group-prepend">
                    <div class="input-group-text">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="price_code_sms{{ $loop->index }}"
                            name="prices[code_sms][{{ $loop->index }}][select]" {{ ($price->price !== null) ? 'checked' : null }}>
                            <input type="hidden" name="prices[code_sms][{{ $loop->index }}][id]"
                            value="{{ $price->id ?? null }}">
                            <input type="hidden" name="prices[code_sms][{{ $loop->index }}][type]"
                            value="code_sms">
                            <label class="custom-control-label" for="price_code_sms{{ $loop->index }}"></label>
                        </div>
                    </div>
                </div>
                ...
                <div class="input-group-prepend">
                    <div class="input-group-text">
                        <div>
                            ...
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="price_code_sms_sync_codes{{ $loop->index }}"
                                name="prices[code_sms][{{ $loop->index }}][codes][sync]">
                                <label class="custom-control-label" for="price_code_sms_sync_codes{{ $loop->index }}">
