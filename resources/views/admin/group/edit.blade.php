            ...
            <div class="col-lg-6 order-lg-last">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control @isValid('url')" id="url" name="url">
                        <option value="{{ $group::WITHOUT_URL }}" {{ old('url', $group->url) == $group::WITHOUT_URL ? 'selected' : null }}>
                            {{ trans('idir::groups.url.'.$group::WITHOUT_URL) }}
                        </option>
                        <option value="{{ $group::OPTIONAL_URL }}" {{ old('url', $group->url) == $group::OPTIONAL_URL ? 'selected' : null }}>
                            {{ trans('idir::groups.url.'.$group::OPTIONAL_URL) }}
                        </option>
                        <option value="{{ $group::OBLIGATORY_URL }}" {{ old('url', $group->url) == $group::OBLIGATORY_URL ? 'selected' : null }}>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control @isValid('apply_status')" id="apply_status" name="apply_status">
                        <option value="{{ $group::APPLY_INACTIVE }}" {{ old('apply_status', $group->apply_status) == $group::APPLY_INACTIVE ? 'selected' : null }}>
                            {{ trans('idir::groups.apply_status.'.$group::APPLY_INACTIVE) }}
                        </option>
                        <option value="{{ $group::APPLY_ACTIVE }}" {{ old('apply_status', $group->apply_status) == $group::APPLY_ACTIVE ? 'selected' : null }}>
            ...
            <div class="col-lg-6 order-lg-first">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control @isValid('visible')" id="visible" name="visible">
                        <option value="{{ $group::VISIBLE }}" {{ old('visible', $group->visible) == $group::VISIBLE ? 'selected' : null }}>
                            {{ trans('idir::groups.visible.'.$group::VISIBLE) }}
                        </option>
                        <option value="{{ $group::INVISIBLE }}" {{ old('visible', $group->visible) == $group::INVISIBLE ? 'selected' : null }}>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control @isValid('backlink')" id="backlink" name="backlink">
                        <option value="{{ $group::WITHOUT_BACKLINK }}" {{ old('backlink', $group->backlink) ==  $group::WITHOUT_BACKLINK ? 'selected' : null }}>
                            {{ trans('idir::groups.backlink.'.$group::WITHOUT_BACKLINK) }}
                        </option>
                        <option value="{{ $group::OPTIONAL_BACKLINK }}" {{ old('backlink', $group->backlink) == $group::OPTIONAL_BACKLINK ? 'selected' : null }}>
                            {{ trans('idir::groups.backlink.'.$group::OPTIONAL_BACKLINK) }}
                        </option>
                        <option value="{{ $group::OBLIGATORY_BACKLINK }}" {{ old('backlink', $group->backlink) == $group::OBLIGATORY_BACKLINK ? 'selected' : null }}>
                ...
                <div class="form-group">
                    ...
                    data-toggle="collapse" aria-expanded="false" aria-controls="collapsePayments">
                        <option value="0" {{ old('payment', $group->prices->isNotEmpty() ? "1" : "0") === "0" ? 'selected' : null }}>{{ trans('idir::groups.payment.0') }}</option>
                        <option value="1" {{ old('payment', $group->prices->isNotEmpty() ? "1" : "0") === "1" ? 'selected' : null }}>{{ trans('idir::groups.payment.1') }}</option>
                    </select>
                ...
                id="collapsePayments">
                    <div class="form-group">
                        ...
                        <select class="form-control @isValid('alt_id')" id="alt" name="alt_id">
                            <option value="" {{ (old('alt_id', $group->alt_id) == null) ? 'selected' : null }}>{{ trans('idir::groups.alt.null') }}</option>
