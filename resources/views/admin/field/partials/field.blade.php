...
>
    <div class="col my-auto d-flex justify-content-between">
        <ul class="list-unstyled mb-0 pb-0">
            ...
            <li>
                <small>{{ trans('icore::filter.created_at') }}: {{ $field->created_at_diff }}</small>
            </li>
            <li>
                <small>{{ trans('icore::filter.updated_at') }}: {{ $field->updated_at_diff }}</small>
            </li>
        </ul>
        <div class="text-right ml-3">
            <div class="responsive-btn-group">
                ...
                <button 
                    ...
                    data-route="{{ route('admin.field.destroy', ['field' => $field->id]) }}" 
                    data-id="{{ $field->id }}"
