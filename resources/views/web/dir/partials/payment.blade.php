        ...
        <div class="tab-content mt-3" id="nav-tabContent">
            ...
            >
                <div class="form-group">
                    ...
                    >
                        @foreach ($pricesByType(Price\Type::TRANSFER)->sortBy('price') as $price)
                        <option 
                            value="{{ $price->id }}"
                            data-content="
            ...
            >
                <div class="form-group">
                    ...
                    >
                        @foreach ($pricesByType(Price\Type::CODE_TRANSFER)->sortBy('price') as $price)
                        <option 
                            value="{{ $price->id }}"
                            data-content="
                                @if ($price->discount_price)
            ...
            >
                <div class="form-group">
                    ...
                    >
                        @foreach ($pricesByType(Price\Type::CODE_SMS)->sortBy('price') as $price)
                        <option 
                            value="{{ $price->id }}" 
                            data-content="
                                @if ($price->discount_price)
                ...
                <p>
                    {!! trans('idir::dirs.payment.code_sms.info', [
                        ...
                        Price\Type::CODE_SMS => $paymentCodeSmsSelection->code,
